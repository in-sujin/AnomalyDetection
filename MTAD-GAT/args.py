...
def get_parser():
    ...
    parser.add_argument("--lookback", type=int, default=100, help='window')
    ...
    parser.add_argument("--bs", type=int, default=256, help='batch')
    ...
    parser.add_argument("--id", type=str, default="", help="ID for saving and loading the model")
