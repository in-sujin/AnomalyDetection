...
def get_data(dataset, max_train_size=None, max_test_size=None,
             normalize=False, spec_res=False, train_start=0, test_start=0, train=True):
    """
    ...
    if train:
        ...
        with open(os.path.join(prefix, "train.pkl"), 'rb') as f:
        ...
        try:
            f = open(os.path.join(prefix, "test_labels.pkl"), "rb")
        ...
        print("test label shape: ", test_data.shape)
